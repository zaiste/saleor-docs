...
During Checkout creation you will need to specify [Channel](channels.mdx). 
- Products not available in Channel cannot be added to Checkout
- Checkout currency is the same as Channels 
- Users are able to create multiple Checkouts, one per Channel
- ShippingMethos can be restricted in some Channels
...
- `channel`: slug of chosen channel. Choosen Channel will impact which products and Shipping Methods can be added to Checkout
